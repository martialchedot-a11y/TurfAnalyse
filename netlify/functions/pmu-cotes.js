...
//
// Le parametre `type` distingue trois usages :
...
// - "rapports" : dividendes officiels (Couplé Gagnant, etc.), tape
//   l'endpoint .../rapports-definitifs.
// =============================================================================
...
exports.handler = async (event) => {
  ...
  const suffixe = type === 'resultat' ? '' : (type === 'rapports' ? '/rapports-definitifs' : '/participants');
