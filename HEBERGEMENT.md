...
|---|---|---|
| Top5 classement | 54,4% | 10 |
| Top5 x Danger(s) (ancienne version) | 36,8% | 5,37 |
| Value top4 (champ entier) | 43,7% | 6 |
| **Value top5 (champ entier)** | **58,2%** | **10** |

"Value top5 (champ entier)" bat strictement le Top5 classement a cout
identique (58,2% contre 54,4% pour 10 combinaisons), et reste coherent
avec le concept Danger : il capture deja naturellement 93,7% des vrais
Danger(s) de la course (3,74 sur 3,99 en moyenne) - rien n'est perdu, les
deux criteres venant de la meme logique de Value negative.
