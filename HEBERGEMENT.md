...
- **Bilan (`bilanCoupleValue`, `js/app.js`)** : suppose **1&euro; jou&eacute;
  sur CHACUNE des 10 combinaisons possibles** entre les 5 candidats du
  Coupl&eacute; Value (C(5,2) = 10 paires, mise 1€/combinaison choisie par
  l'utilisateur), soit 10&euro; mis&eacute;s par course feu vert. Chaque
