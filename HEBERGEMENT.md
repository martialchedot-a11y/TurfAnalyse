...
par hippodrome...) ont ete calcules AVANT ce correctif et peuvent donc etre
legerement optimistes pour les courses ou le fichier musiques source
contenait deja le resultat du jour analyse. Si une re-verification de ces
chiffres avec le correctif applique est souhaitee, elle peut etre faite sur
demande.
