...
// Score Global (top2, reduit du top3 depuis v15 - voir v13 ci-dessous), on
// retient celui qui a le meilleur `scoreAptitude`, via DEUX sources de cote
// possibles :
//
...
//   Global sur l'AUTRE candidat du top2 est >= 15.
//
 ...
 *   chevaux ont un `classement` 1-2 (champ trop petit), ou si aucun
 *   candidat ne qualifie dans aucun des deux modes. `rangChoisi` =
