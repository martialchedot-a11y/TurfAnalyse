// =============================================================================
// jeuSimpleGagnant.js
// "Jeu Simple Gagnant" (v10, aout 2026) : ne retient plus QUE le rang 1 du
...
//   Cote 8H       > 3,8 ET ecart de Score Global (rang1 vs rang2) >= 10
//     -> "1er du classement 8h", UNIQUEMENT si le rang 1 ne qualifie PAS
//        deja en cote directe (memes seuils, memes criteres, seule la
 ...
 *   de Score Global avec le rang 2 est >= `SEUIL_ECART_SCORE_RANG1` ; sinon,
 *   qualifie en cote 8h (`rang1Value:false, mode8h:true`) avec EXACTEMENT
 *   les memes criteres appliques a `entry.cote8h`. La cote directe est
...
export function jeuSimpleGagnant(chevaux) {
  ...
  const ecartOk = ecartScoreRang1 !== null && ecartScoreRang1 >= SEUIL_ECART_SCORE_RANG1;
