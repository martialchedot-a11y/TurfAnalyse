// =============================================================================
// jeuSimpleGagnant.js
// "Jeu Simple Gagnant" (v14, aout 2026) : parmi les 3 PREMIERS du classement
...
//   Sinon, parmi les candidats du top3 dont la cote DIRECTE > 3,8 : celui au
...
//   Global sur le meilleur des 2 AUTRES candidats du top3 est >= 15.
//
 ...
 *   (85) ET son scoreForme >= `SEUIL_SCORE_FORME_RANG1` (70, v14). Sinon
 *   (aucun candidat direct ne qualifie), parmi les candidats du top3 dont
 ...
 *   ET que son ecart de Score Global sur le meilleur des 2 AUTRES candidats
 *   du top3 est >= `SEUIL_ECART_SCORE_RANG1_8H` (15). La cote directe est
 *   toujours prioritaire quand les deux qualifient. Non jouable
 *   (`rentable:false`) si l'hippodrome est exclu (`hippodromeExclu:true`),
