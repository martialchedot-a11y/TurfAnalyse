// =============================================================================
// jeuSimpleGagnant.js
// "Jeu Simple Gagnant" (v6, aout 2026) : joue UNIQUEMENT le 1er du
// classement Score Global (rang 1), et seulement si sa cote REELLE depasse
// un seuil FIXE de rentabilite calibre empiriquement sur 8 mois d'archives
// reelles (7456 courses - voir HEBERGEMENT.md) :
//
...
//
// *** v6 (aout 2026, a la demande de l'utilisateur) *** : le Dutching
// combinant plusieurs rangs (v4/v5) est SUPPRIME de cette page, y compris
// comme option facultative. Un backtest cible avait deja montre que le
// Dutching sans le rang 1 etait fragile (102,8% sur 2137 courses, negatif
// des qu'on retire 5 a 10 gros gains - voir HEBERGEMENT.md), ce qui avait
// motive de rendre le rang 1 obligatoire (v5). Le Dutching combine restait
// alors propose en complement quand le rang 1 qualifiait deja - il est
// desormais retire entierement : seul le rang 1, joue seul, est propose.
// =============================================================================
 ...
 *   seuil (cote > 3,8). `principal` = "jouer le rang 1 seul" (Dutching a 1
 *   cheval, rendement = sa cote). `alternative` conserve `null` pour la
 *   compatibilite (plus aucun Dutching multi-chevaux propose sur cette
 *   page). `recommande` = `principal`.
 */
