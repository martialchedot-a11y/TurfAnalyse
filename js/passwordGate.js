...
//
// La cle de memorisation (CLE_STOCKAGE) inclut les premiers caracteres du
// hash attendu : ainsi, tout changement de mot de passe (donc de hash)
// invalide automatiquement le deverrouillage memorise sur TOUS les
// appareils, qui devront ressaisir le nouveau mot de passe une fois.
//
...
(function () {
  const HASH_ATTENDU = 'abc2c274bc3ce4434e4dccc5da9f4a5e34023a45286409a7b7af07aba8da1ab1';
  const CLE_STOCKAGE = 'turfanalyse_acces_ok_' + HASH_ATTENDU.slice(0, 8);
