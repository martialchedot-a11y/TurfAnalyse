...
// "Bilan Global Simple Gagnant" dans js/app.js).
// =============================================================================
...
export async function exportAll() {
  const [performances, meetings, races, horses, journal, predictionsExternes, bilansJournaliersSimpleGagnant] = await Promise.all([
    getAllPerformances(),
    getAllMeetings(),
  ...
  return { version: DB_VERSION, exportedAt: new Date().toISOString(), performances, meetings, races, horses, journal, predictionsExternes, bilansJournaliersSimpleGagnant };
}

export async function importAll(data) {
  const t = await tx(['performances', 'meetings', 'races', 'horses', 'journal', 'predictionsExternes', 'bilansJournaliersSimpleGagnant'], 'readwrite');
