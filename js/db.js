...
export async function exportAll() {
  const [performances, meetings, races, horses, journal, bilansJournaliersSimpleGagnant, bilansJournaliersCroisement, topIAPlace] = await Promise.all([
    getAllPerformances(),
    getAllMeetings(),
  ...
  return { version: DB_VERSION, exportedAt: new Date().toISOString(), performances, meetings, races, horses, journal, bilansJournaliersSimpleGagnant, bilansJournaliersCroisement, topIAPlace };
}

export async function importAll(data) {
  const t = await tx(['performances', 'meetings', 'races', 'horses', 'journal', 'bilansJournaliersSimpleGagnant', 'bilansJournaliersCroisement', 'topIAPlace'], 'readwrite');
