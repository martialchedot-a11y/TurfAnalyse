...
function jeuSimpleGagnantHtml(chevaux, scoreConfiance) {
  ...
  if (!jeu.rentable) {
    ...
    return `<div class="card" style="margin-bottom:10px;">
        ...
        <p class="muted small" style="margin-top:4px;">Aucune combinaison de 2 &agrave; 8 chevaux (class&eacute;s par Score Global, cote r&eacute;elle connue) ne d&eacute;passe le seuil de rentabilit&eacute; de sa tranche de confiance (${TRANCHE_CONFIANCE_LABEL[tranche]}) sur cette course. Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
      </div>`;
  }
