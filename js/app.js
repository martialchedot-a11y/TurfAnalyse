...
function jeuSimpleGagnantHtml(chevaux) {
  ...
  if (!jeu.rentable) {
    return `<div class="card" style="margin-bottom:10px;">
        ...
        <p class="muted small" style="margin-top:4px;">Ni le 1er du classement Score Global (seuil de cote 3,8 ET &eacute;cart de Score Global &ge;10 sur le 2e), ni un seul autre rang parmi 2/4/5 (seuils 5,2/9,4/12,5) ne qualifie. Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
      </div>`;
  }
