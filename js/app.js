...
import { jeuSimpleGagnant, misesJeuSimpleGagnant, MISES_PRESETS_JEU_SIMPLE_GAGNANT, trancheConfiance } from './engine/jeuSimpleGagnant.js';
...
function jeuSimpleGagnantHtml(chevaux, scoreConfiance) {
  ...
  if (!jeu.rentable) {
    return `<div class="card" style="margin-bottom:10px;">
        ...
        <p class="muted small" style="margin-top:4px;">Aucune combinaison de 2 &agrave; 8 chevaux (class&eacute;s par Score Global, cote r&eacute;elle connue) ne d&eacute;passe le seuil de rentabilit&eacute; de sa tranche de confiance (${TRANCHE_CONFIANCE_LABEL[trancheConfiance(scoreConfiance)]}) sur cette course. Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
      </div>`;
  }
...
// Coupl&eacute; Value fait partie des 3 profils identifies initialement
// comme rentables sur un premier echantillonnage de rapports PMU reels
// (2 mois) - voir PROFILS_RENTABLES_COUPLE_VALUE et le badge "Jeu
// conseille" plus haut, sur la fiche course) : forte-moyenne, moyenne-
// faible, faible-moyenne. *** Sur 8 mois d'archives et un echantillon
// elargi, le ROI pondere des 3 profils est retombe a environ +1% (quasi
// nul) *** - resultat desormais exploratoire uniquement - voir HEBERGEMENT.md.
//
...
// affiche en info-bulle/texte sur la page liste. Chiffres actualises sur 8
// mois (janvier a 11 aout 2026) - la baisse continue par rapport aux
// chiffres 2/3 mois confirme que les estimations initiales etaient
// optimistes (petit echantillon, dividendes tres asymetriques).
const PROFILS_RENTABLES_ROI = {
  'forte-moyenne': '+17% de ROI mesure sur 8 mois (n=152 courses - en baisse continue : +75% sur 2 mois, +39% sur 3 mois, +17% sur 8 mois)',
  'moyenne-faible': '+4% de ROI mesure sur 8 mois (n=41 courses - toujours l\'echantillon le plus reduit des 3 ; +61% -> +22% -> +4% sur 2/3/8 mois)',
  'faible-moyenne': '-0.5% de ROI mesure sur 8 mois (n=890 courses - le plus large echantillon des 3, desormais legerement negatif ; +61% -> +18% -> -0.5% sur 2/3/8 mois)'
};
...
async function renderCoupleRentable() {
  ...
  const introHtml = `<div class="card" style="margin-bottom:10px;">
      <p class="small muted" style="margin:0;">3 profils confiance/confirmations identifi&eacute;s initialement comme rentables, r&eacute;&eacute;valu&eacute;s sur un &eacute;chantillonnage de rapports PMU r&eacute;els &eacute;largi (8 mois, janvier &agrave; 11 ao&ucirc;t 2026) : <strong>forte-moyenne</strong> (+17%), <strong>moyenne-faible</strong> (+4%), <strong>faible-moyenne</strong> (-0.5%). Le ROI pond&eacute;r&eacute; des 3 profils est retomb&eacute; &agrave; environ +1% (quasi nul), en baisse continue depuis 2 mois (+75%/+48%/+61%) et 3 mois (+39%/+22%/+18%) - le signal est d&eacute;sormais faible et exploratoire uniquement - voir HEBERGEMENT.md.</p>
    </div>`;
...
async function renderCoupleRentableResultat() {
  ...
  const introHtml = `<div class="card" style="margin-bottom:10px;">
      <p class="small muted" style="margin:0;">Suivi des courses au profil forte-moyenne, moyenne-faible ou faible-moyenne (Coupl&eacute; Value) - r&eacute;sultat exploratoire, 3 mois d'archives (ROI toujours positif mais revu &agrave; la baisse depuis l'ajout de juin). Voir HEBERGEMENT.md.</p>
    </div>`;
