...
// *** Signal "jeu conseille" (aout 2026, mis a jour avec juin) *** : a la
// demande de l'utilisateur, suite au tableau ROI reel par profil confiance x
// confirmations, 3 profils se sont demarques comme rentables. Chiffres
// actualises sur 3 mois d'archives (janvier + juin + juillet 2026, apres
// ajout de juin par l'utilisateur) :
//   - faible-moyenne : +18% de ROI (n=495 courses, echantillon le plus
//     large - ROI toujours positif mais nettement revu a la baisse par
//     rapport aux +61% mesures sur 2 mois seulement)
//   - forte-moyenne  : +39% de ROI (n=67 courses - ROI divise par 2 par
//     rapport aux +75% sur 2 mois, confirmant la fragilite deja identifiee,
//     l'echantillon initial etait domine par un seul rapport extreme a 299e)
//   - moyenne-faible : +22% de ROI (n=25 courses - toujours l'echantillon le
//     plus reduit des 3, prudence maximale)
// *** Resultat toujours exploratoire *** : les 3 profils restent positifs
// apres l'ajout d'un 3e mois, mais la baisse marquee de leur ROI (parfois
// divise par 2 ou 3) montre que les chiffres sur 2 mois etaient optimistes
// (bruit d'echantillon). A confirmer sur d'autres mois - voir HEBERGEMENT.md
...
// affiche en info-bulle/texte sur la page liste. Chiffres actualises sur 3
// mois (janvier + juin + juillet 2026) - la baisse marquee par rapport aux
// chiffres 2 mois montre que ces derniers etaient optimistes (petit echantillon).
const PROFILS_RENTABLES_ROI = {
  'forte-moyenne': '+39% de ROI mesure sur 3 mois (n=67 courses - en baisse par rapport aux +75% mesures sur 2 mois, confirmant la fragilite deja identifiee)',
  'moyenne-faible': '+22% de ROI mesure sur 3 mois (n=25 courses - toujours l\'echantillon le plus reduit des 3, prudence maximale)',
  'faible-moyenne': '+18% de ROI mesure sur 3 mois (n=495 courses - le plus large echantillon des 3, mais ROI nettement revu a la baisse par rapport aux +61% sur 2 mois)'
};
...
async function renderCoupleRentable() {
  ...
  const introHtml = `<div class="card" style="margin-bottom:10px;">
      <p class="small muted" style="margin:0;">3 profils confiance/confirmations identifi&eacute;s comme rentables sur un &eacute;chantillonnage de rapports PMU r&eacute;els (3 mois, janvier + juin + juillet 2026) : <strong>forte-moyenne</strong> (+39%), <strong>moyenne-faible</strong> (+22%), <strong>faible-moyenne</strong> (+18%). ROI toujours positif mais nettement revu &agrave; la baisse depuis l'ajout de juin (etait +75%/+48%/+61% sur 2 mois) - r&eacute;sultat exploratoire, en cours de validation sur davantage de mois d'archive - voir HEBERGEMENT.md.</p>
    </div>`;
