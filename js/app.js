...
import { fetchCotesPmu, fetchResultatPmu, fetchRapportsPmu, extraireRapportsTrio, extraireRapportsSimpleGagnant, extraireRapportsSimplePlace } from './engine/pmuApi.js';
      ...
      for (let i = 0; i < aRecuperer.length; i++) {
        ...
        try {
          ...
          if (json) {
            ...
            // Recupere aussi, dans la MEME reponse (aucune requete reseau
            // supplementaire), les rapports Simple Gagnant/Place - utilises
            // par la page Course feu vert pour la Base (voir rapportSimpleHtml).
