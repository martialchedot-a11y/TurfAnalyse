...
function jeuSimpleGagnantHtml(chevaux, hippodrome) {
  ...
  if (!jeu.rentable) {
    const raison = jeu.hippodromeExclu
      ...
      : `Aucun des 3 premiers du classement Score Global ne qualifie ni en cote directe (seuil 3,8, aptitude &ge;85, forme &ge;70) ni en cote 8h (seuil 3,8, &eacute;cart &ge;15, aptitude &ge;85, forme &ge;70).`;
    return `<div class="card" style="margin-bottom:10px;">
