...
import { jeuSimpleGagnant, misesJeuSimpleGagnant, MISES_PRESETS_JEU_SIMPLE_GAGNANT, bilanJeuSimpleGagnant, rendementBilan, cumulerBilansJournaliers, multiplicateurMiseAptitudeRang1, SEUIL_SCORE_FORME_RANG1, SEUIL_SCORE_APTITUDE_RANG1 } from './engine/jeuSimpleGagnant.js';
...
function jeuSimpleGagnantHtml(chevaux, hippodrome, disciplineCanonique, typeCourse) {
  ...
  return `<div class="card" style="margin-bottom:10px;">
      ...
      <p class="muted small" style="margin-top:8px;">Mise flat sur le rang 1 (Dutching &agrave; 1 cheval, rendement = sa cote). Seuil de cote calibr&eacute; sur archives r&eacute;elles (voir HEBERGEMENT.md).${jeu.scoreAptitudeRang1 != null ? ' Mise renforc&eacute;e (optionnelle, v17) : x2 si scoreAptitude &ge;100, x1 sinon &mdash; rendement pond&eacute;r&eacute; mesur&eacute; 131,7% &rarr; 137,1% sur l\'archive compl&egrave;te, remplace l\'ancienne mise par palier d\'&eacute;cart (retest&eacute;e contre-productive sur le pool actuel, voir HEBERGEMENT.md).' : ''} Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
    </div>`;
}
...
function bindJeuSimpleGagnant(chevaux, hippodrome, disciplineCanonique, typeCourse) {
  ...
  btn.addEventListener('click', () => {
    ...
    if (jeu.scoreAptitudeRang1 != null && aptitudeCheck && aptitudeCheck.checked) {
      multiplicateurApplique = multiplicateurMiseAptitudeRang1(jeu.scoreAptitudeRang1);
    ...
    const miseAptitudeInfoHtml = multiplicateurApplique !== 1
      ? `<p class="small tag-blue bold" style="margin-top:4px;">Mise renforc&eacute;e appliqu&eacute;e : x${fmt1(multiplicateurApplique)} (scoreAptitude ${fmt1(jeu.scoreAptitudeRang1)})</p>`
      : '';
    resultEl.innerHTML = `
