...
import { jeuSimpleGagnant, misesJeuSimpleGagnant, MISES_PRESETS_JEU_SIMPLE_GAGNANT } from './engine/jeuSimpleGagnant.js';
...
function jeuSimpleGagnantHtml(chevaux) {
  ...
  if (!jeu.rentable) {
    return `<div class="card" style="margin-bottom:10px;">
        ...
        <p class="muted small" style="margin-top:4px;">Aucune combinaison de 2 &agrave; 8 chevaux (class&eacute;s par Score Global, cote r&eacute;elle connue) ne d&eacute;passe son seuil de rentabilit&eacute; sur cette course. Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
      </div>`;
  }
  ...
  return `<div class="card" style="margin-bottom:10px;">
      ...
      <p class="small" style="margin:0 0 8px;">Rendement esp&eacute;r&eacute; : <span class="tag-green bold">${(jeu.rendement * 100).toFixed(1)}%</span> &middot; minimum requis pour ${jeu.n} chevaux : ${(jeu.seuil * 100).toFixed(0)}%</p>
