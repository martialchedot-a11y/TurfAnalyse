...
function renderImport() {
  ...
  appEl.innerHTML = `
    ...
    <div class="card">
      ...
      <p class="muted small">Fichiers CSV "Statistiques Ecarts Jockeys/Entraineurs | Turf BZH" (export &agrave; convertir en CSV avant import, ex. Excel &gt; Enregistrer sous &gt; CSV UTF-8). Photo des 90 derniers jours &agrave; la date d'export - chaque r&eacute;import REMPLACE enti&egrave;rement le pr&eacute;c&eacute;dent. Sert au badge "Jockey+entra&icirc;neur en forme" (Jeu Simple Gagnant/Liste des courses) : suivi PROSPECTIF, purement indicatif, n'entre dans aucun calcul de Score Global/Value/classement/dominance MX+OR+MA (voir HEBERGEMENT.md pour le d&eacute;tail et la r&eacute;serve m&eacute;thodologique).</p>
      <div class="field"><label>Fichier Jockeys</label><input type="file" id="file-ecarts-jockeys" accept=".csv,text/csv,text/plain"></div>
      <div class="field" style="margin-top:8px;"><label>Fichier Entraineurs</label><input type="file" id="file-ecarts-entraineurs" accept=".csv,text/csv,text/plain"></div>
    </div>
