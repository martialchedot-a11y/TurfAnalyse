    ...
    resultEl.innerHTML = `
      <div class="stat-grid">${mises.map((m) => `
        <div class="stat-cell">
          ...
          <div class="l">cote ${fmt1(m.cote)} &middot; mise ${m.mise.toFixed(2)}&euro;</div>
        </div>
      `).join('')}</div>
      <p class="small" style="margin-top:6px;">Gain si l'un de ces ${jeu.n} chevaux gagne : <span class="tag-green bold">${mises[0].gain.toFixed(2)}&euro;</span> (identique pour tous, principe du Dutching)</p>
    `;
  });
}
