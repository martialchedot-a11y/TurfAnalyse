...
async function renderBilanSimpleGagnant() {
  ...
  const introHtml = `<div class="card" style="margin-bottom:10px;">
      <p class="small muted" style="margin:0;">Courses dont le Jeu Simple Gagnant est jouable (v19) : au moins un cheval Value &le; -30 avec cote &ge; 3, departag&eacute; par dominance stricte MX+OR+MA si plusieurs candidats - voir la fiche course pour le d&eacute;tail, et HEBERGEMENT.md pour la m&eacute;thode.</p>
    </div>`;
