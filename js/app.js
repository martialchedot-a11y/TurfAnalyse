 ...
 * possibles (memes seuils/criteres dans les deux cas - cote > 3,8 ET ecart
 * de Score Global &ge;10 sur le rang 2) :
 *   - "1er du classement seul" : cote DIRECTE (prioritaire).
 *   - "1er du classement 8h" : cote 8H, uniquement si la cote directe ne
 *     qualifie pas. Remplace l'ancien mode "Cheval value seul" (rangs
 *     2/4/5 + score Croisement, retire - voir HEBERGEMENT.md).
 */
...
function jeuSimpleGagnantHtml(chevaux) {
  ...
  if (!jeu.rentable) {
    return `<div class="card" style="margin-bottom:10px;">
        ...
        <p class="muted small" style="margin-top:4px;">Le 1er du classement Score Global ne qualifie ni en cote directe ni en cote 8h (seuil de cote 3,8 ET &eacute;cart de Score Global &ge;10 sur le 2e, dans les deux cas). Indicatif, n'entre dans aucun calcul de Score Global/Value/classement.</p>
      </div>`;
  }
