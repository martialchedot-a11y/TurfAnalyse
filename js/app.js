 ...
 * sur le meme backtest : elargir la base a TOUTE Base tres solide (pas
 * seulement l'ancre confirmee+classee n1) et prendre 5 candidats par
 * Value donne **61,0%** quand la base finit deja Top3 (n=692, pour ~10
 * combinaisons) - legerement mieux, et applicable a bien plus de courses
 * (n=692 contre 423, la base n'ayant plus besoin d'etre confirmee
 * techniquement ET classee n1).
 *
...
const TRIO_VALUE_STATS = '61,0% de reussite quand la base finit deja Top3 (n=692) - backtest 3 mois, 3037 courses';
