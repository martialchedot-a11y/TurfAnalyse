...
// IMPORTANT : garder cette valeur synchronisee avec APP_VERSION dans
// js/app.js (affichee dans la barre du haut de l'appli) a chaque livraison.
const CACHE_NAME = 'turf-analyse-v110';
const ASSETS = [
  './',
  './index.html',
  ...
  './js/engine/pmuApi.js',
  './js/engine/topIAPlaceParser.js',
  './js/engine/supplementationParser.js',
  './js/engine/jeuSimpleGagnant.js',
  './js/engine/jeuSimpleGP.js',
  './js/engine/jeuCoupleTrioCroisement.js',
  './js/engine/surveillance.js',
  './icons/icon-192.png',
  './icons/icon-512.png',
