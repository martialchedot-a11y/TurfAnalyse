...
// -------------------------------------------------------------------
// Jeu Simple Gagnant v7 (aout 2026) : le rang 1 reste prioritaire des
// qu'il depasse son seuil (3,8). S'il ne qualifie pas mais qu'un SEUL
// autre rang parmi {2, 4, 5} depasse le sien, ce cheval est joue seul
// ("Cheval value seul (rang hors 1)"). Si 2 rangs ou plus parmi {2, 4, 5}
// qualifient sans que le rang 1 qualifie, non jouable (Dutching
// multi-chevaux exclu, trop fragile par backtest). `alternative` vaut
// toujours `null` (aucun Dutching multi-chevaux propose sur cette page).
// -------------------------------------------------------------------
...
test('jeuSimpleGagnant: rang 1 non value mais un seul autre rang value -> principal = ce cheval seul', () => {
  const chevaux = [
