...
import { jeuSimpleGagnant, misesJeuSimpleGagnant, SEUILS_VALUE_RANG_SIMPLE_GAGNANT, SEUIL_ECART_SCORE_RANG1, bilanJeuSimpleGagnant, rendementBilan, cumulerBilansJournaliers } from '../js/engine/jeuSimpleGagnant.js';
...
// sur cette page).
// -------------------------------------------------------------------
function chevalPourJsg(numero, classement, cote, scoreGlobal = 0) {
  return { entry: { numero }, classement, cotePourAffichage: cote, scoreGlobal };
}
